var VimariContentFeatures = (function () {
    "use strict";

    var HOST_ATTRIBUTE = "data-vimari-overlay";
    var BASE_STYLE = `
    ...
    OverlayManager.prototype.showHelp = function (commands) {
        ...
        </style><div class="backdrop"><section class="panel help" role="dialog" aria-modal="true" aria-labelledby="vimari-help-title"><header><h2 id="vimari-help-title">Vimari+ shortcuts</h2><button aria-label="Close help">×</button></header><table><tbody>${rows}</tbody></table></section></div>`;
    ...
    ClipboardController.prototype.copy = async function (text, label) {
        ...
        this.overlays.showStatus(copied ? `${label || "Value"} copied` : "Vimari+ could not access the clipboard.", copied ? "success" : "error");
        return copied;
    };
...
if (typeof module !== "undefined") {
    module.exports = VimariContentFeatures;
    global.VimariContentFeatures = VimariContentFeatures;
}
